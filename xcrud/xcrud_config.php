<?php /** Configuration file; f0ska xCRUD v.1.6.3; 12/2013 */
class Xcrud_config
{
    // default connection
    public static $dbname = 'returnon_canb'; // Your database name
    public static $dbuser = 'returnon_canb'; // Your database username
    public static $dbpass = ')mUG{NK8iP!['; // // Your database password
    ...
    public static $limit = 50; // default limit of rows per page
    ...
    public static $enable_limitlist = false; // show row numbers in grid
    ...
    // map
    public static $default_point = '22.7195687,75.85772580000003';
